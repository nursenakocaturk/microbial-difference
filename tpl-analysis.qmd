...
```{r}
Dentin_Shannon <- alpha$Shannon[alpha$Tissue == "Dentin"]

Cementum_Shannon <- alpha$Shannon[alpha$Tissue == "Cementum"]
```
...
```{r}
Dentin_Simpson <- alpha$Simpson[alpha$Tissue == "Dentin"]

Cementum_Simpson <- alpha$Simpson[alpha$Tissue == "Cementum"]
...
```{r}
Dentin_Invsimpson <- alpha$Invsimpson[alpha$Tissue == "Dentin"]

Cementum_Invsimpson <- alpha$Invsimpson[alpha$Tissue == "Cementum"]
```
